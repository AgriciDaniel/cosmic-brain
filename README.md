...
- [claude-obsidian: Self-Organizing AI Second Brain for Obsidian + Claude Code](#claude-obsidian-self-organizing-ai-second-brain-for-obsidian--claude-code)
  - [Contents](#contents)
  - [What It Does](#what-it-does)
    - [YouTube Demo](#youtube-demo)
  - [Why claude-obsidian?](#why-claude-obsidian)
  - [Quick Start](#quick-start)
    - [Option 1: Clone as vault (recommended, full setup in 2 minutes)](#option-1-clone-as-vault-recommended-full-setup-in-2-minutes)
    - [Option 2: Install as Claude Code plugin](#option-2-install-as-claude-code-plugin)
    - [Option 3: Add to an existing vault](#option-3-add-to-an-existing-vault)
  - [Commands](#commands)
  ...
  - [Architecture](#architecture)
    ...
    - [Multi-writer safety (v1.7+)](#multi-writer-safety-v17)
    - [Hybrid retrieval (v1.7+, opt-in)](#hybrid-retrieval-v17-opt-in)
  - [MCP Setup (Optional)](#mcp-setup-optional)
  - [Plugins](#plugins)
    - [Core Plugins (built into Obsidian, no install needed)](#core-plugins-built-into-obsidian-no-install-needed)
    - [Pre-installed Community Plugins (ship with this vault)](#pre-installed-community-plugins-ship-with-this-vault)
    - [Also install from Community Plugins (not pre-installed)](#also-install-from-community-plugins-not-pre-installed)
  - [CSS Snippets (auto-enabled by setup-vault.sh)](#css-snippets-auto-enabled-by-setup-vaultsh)
  - [Banner Plugin](#banner-plugin)
  - [File Structure](#file-structure)
  - [AutoResearch: program.md](#autoresearch-programmd)
...
Also install the **[Obsidian Web Clipper](https://obsidian.md/clipper)** browser extension. Sends web pages to `raw/` in one click — in the extension settings, set the destination folder to `raw/` (no leading dot). If you have a legacy vault that still uses `.raw/`, run `bash bin/migrate-raw-folder.sh` once to rename it.
