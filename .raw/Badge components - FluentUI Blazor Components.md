...
source: "https://fluentui-blazor-v5.azurewebsites.net/Badges"
author:
published:
created: 2026-05-23
description:
...
A badge component is a visual indicator that communicates a status or description of an associated component. It uses short text, color, and icons for quick recognition and is placed near the relevant content.
...
```
- If the text of the badge itself is not sufficient to convey its meaning, the parent element should be given an explicit label:
```xml
...
- [Badge](https://fluentui-blazor-v5.azurewebsites.net/Badges/Badge)
- [CounterBadge](https://fluentui-blazor-v5.azurewebsites.net/Badges/CounterBadge)
- [PresenceBadge](https://fluentui-blazor-v5.azurewebsites.net/Badges/PresenceBadge)

## On this page

- [Best practices](https://fluentui-blazor-v5.azurewebsites.net/Badges#best-practices)
