...
Installation Guide SQL Server 2017
...
InstallationGuide_MW40_SQL2017.docx  Version: 1.0.23049
...
Installation SQL Server 2017 SE ................................................................. 4
...
Installing SQL Server 2017 .................................................................................. 7

1.2.1.

Installing additional Database Instance.................................................. 22

1.3.

Installing SQL Server Management Studio ........................................................ 30

1.4.

Installing Service Pack ...................................................................................... 32

1.4.1.

Installing Cumulative Update Package .................................................. 33

1.5.  Post Installation Configuration ........................................................................... 34

1.6.  Database ........................................................................................................... 39

1.6.1.  Create Database ................................................................................... 39

1.6.2.  Create Database User ........................................................................... 44

1.6.3.  ODBC Configuration .............................................................................. 48

1.6.4.  Remap Database User to SQL Server Login ......................................... 53

1.7.  Separate Database and Application Server ....................................................... 54

1.7.1.

Installing SQL Server Client ................................................................... 55

1.7.2.  ODBC Configuration .............................................................................. 56

1.7.3.

Installing SQL Server Management Studio ............................................ 56

1.7.4.

Installing Microsoft ODBC Driver 13.1 ................................................... 57

1.7.5.

Installing Microsoft Command Line Utilities ........................................... 59
...
Installation SQL Server 2017 SE
...
This  manual  explains  how  to  install  Microsoft  SQL  Server  2017  Standard  Edition  for  use  with  MPDVs
...
Installation DVD or installation files for the required edition of “SQL Server 2017”, e.g. for Standard
...
de_sql_server_2017_standard_x64_dvd_11294484.iso
...
  Service Pack (SP) and  Cumulative Update  Package  (CP) installation files for  SQL Server  2017
...
1.2.  Installing SQL Server 2017
...
D:\SQLServer\MSSQL14.MIPMS1\MSSQL\Backup
...
Tab "FILESTREAM":  no changes necessary
...
Start an installation as described in chapter “1.2. Installing SQL Server 2017”

To install a new instance of SQL Server please proceed as follows:

Perform a new installation of SQL Server 2017
...
D:\SQLServer\MSSQL14.MIPMS2\MSSQL\Backup
...
Start the “SQL Server Configuration Manager”, e.g.:
Start-Button – Microsoft SQL Server 2017 – SQL Server 2017 Configuration Manager
...
Start-Button – Microsoft SQL Server Tools 17 – Microsoft SQL Server Management Studio
...
<SECRET sa PASSWORD> (see chapter “1.2. Installing SQL Server 2017”)
...
db_mip_sql2017.sql (or db_mip_sql2017.bsp)
...
Check if the database creation script db_mip_sql2017.sql is available in the above mentioned directories.

If not, make a copy of the file db_mip_sql2017.bsp, e.g.:

copy d:\mip1\db_sql\db_mip_sql2017.bsp d:\mip1\db_sql\db_mip_sql2017.sql
...
FILENAME=N'E:\SQLServer\MSSQL14.MIPMS1\MSSQL\DATA\rootdbs_Data.MDF'
...
Create a backup copy of the edited database creation script db_mip_sql2017.sql, e.g.:

copy d:\mip1\db_sql\db_mip_sql2017.sql d:\mip1\db_sql\db_mip_sql2017_mip1.sql
...
Open the database creation script (e.g. db_mip_sql2017.sql) in menu “File  Open  File…”

Installation Guide SQL Server 2017

Select file, e.g.: d:\mip1\db_sql\db_mip_sql2017.sql
...
The database creation script “db_mip_sql2017.sql” needs to be duplicated and adjusted accordingly.

Make sure to save a copy of the new script using a unique file name, e.g.:

d:\mip1\db_sql\db_mip_sql2017_mip2.sql
...
sp_password 'oldpw', 'newpw', 'user'

e.g.:

USE master

sp_password 'mipadm', 'NewSecurePW', 'mipadm'
