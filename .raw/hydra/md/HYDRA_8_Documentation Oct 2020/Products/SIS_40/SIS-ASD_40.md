...
Logging per dialog ......................................................................................................... 8

Logging per service ....................................................................................................... 9

3  Logging Key Maintenance .......................................................................... 12

4  Logging - Change Management................................................................. 14

5  Logging-Specific Configurations ................................................................ 16

6  Logging Key Overview ............................................................................... 19
...
ASD_4.0\MBL_Base_system_logging.docx>>
...
Use the application if you want to change or activate the storage for changes of objects.

Integration

The logging function is a central function available for all master data objects, dialogs and services.
...
Logging of dialog calls for a called dialog.

Object

Logging  of  objects  that  are  firmly  stored  in  the  software  including  the  respective  values.  You  can

restrict logging to the actions of the respective objects. In this case, you cannot enter comments /
...
The object identifies a system data object.

Example:

You want to log changes of the machine configuration. The object identification for the machine

is "MNR". In this case, you must define “MNR” as object.
...
You  want  to  log  all  changes  made  to  the  machine  configuration.  The  object  identification  for  the

machine is "MNR". In this case, you must define “MNR” as object and “%” as action.

You only want to log changes (UPDATE) of the machine configuration. The object identification for

the machine is "MNR". In this case, you must define “MNR” as object and “UPDATE” as action.
...
communication  to  upload  data  “online”.  Here  the  feedback  program  is  informed  by  the  logging

application. To let the system know which program is to be informed, enter the program name here

in lower case letters without file extension, e.g. “myerprck“.
...
When  data  is  uploaded  from  the  system  logging  function  to  external  systems,  the  logging
...
  Key
In this case, only fields configured as keys to the object are logged by the system.
...
  Service calls (clients/interface)
...
You use Logging Change Management if you want to compare several recorded changes to one object.

Integration

Logging is a central functional feature available for all master data objects, dialogs and services.
...
5  Logging-Specific Configurations
...
By default, the logging data is stored in the online data set for 35 days. After this time, the data is moved

to archive tables. In the archive tables, the retention period for logging data is three years. After this time,

the data is deleted.

Configuration

Configure  the  archiving  in  the  application  Data  management.  The  archiving  function  provides  the
...
When the data has been deleted from the archive tables, you cannot reload this data any more.

Reason:  The  logging  data  is  archived  in  BLOB  fields  and  is  deleted  from  the  archive  tables

when the retention period has expired.

Version upgrade to MW 4.0pe

After  the  version  upgrade  to  MW4.0pe,  you  should  use  the  current  logging  archiving  after  consultation

with the customer.

The patch dbp_archive_auditlog.hsc adds the above-mentioned configurations to the data management.

Windows
hydscr.exe db_sql\dbp_archive_auditlog.hsc

Linux
hydscr.out db_sql/dbp_archive_auditlog.hsc

Check if the following entry is available in the archiving script hyarc.scr (d:\mip1):

# Start AuditLog archiving
if [ `hyd_patchchk.exe -r ARCHIVE_AUDITLOG` -gt 0 ]
then
  echo "AuditLog:" >> $ERRPATH/hyarc.pro
  hymwarc.exe -d -z "PROD=AUDITLOG|REORG_VERW_TABLE=1|" >
$ERRPATH/hymwarc_auditlog.pro
  cat $ERRPATH/hymwarc_auditlog.pro >> $ERRPATH/hyarc.pro
  sleep 1
fi
# End AuditLog archiving

If required, you can copy the entry from the template hyarc.bsp.
