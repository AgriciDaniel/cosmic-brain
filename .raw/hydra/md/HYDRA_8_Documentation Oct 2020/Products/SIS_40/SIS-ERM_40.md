...
Depending  on  the  configuration  of  the  paths  on  the  server,  the  report  file  is  located  in  the

configured path MOCREP (e.g. \\MyServer\HYDRA3\3\custom\reports\MyTestReport.lul).
...
format.  You  must  bear  in  mind  and  test  the  output  format  when  you  design  a  report.    Common

output formats are PDF and perhaps HTML.
