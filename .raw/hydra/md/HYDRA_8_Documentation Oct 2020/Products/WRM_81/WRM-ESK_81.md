...
WRM-ESK_81.docx Version: 1.0.23049 Page 2 of 6

|     |     |     | WRM Escalation Messages  |     |
| --- | --- | --- | ------------------------ | --- |

Contents
1  Overview of Escalation Messages for Shop Floor Data Collection .............. 4
...
| WRM-ESK_81.docx  |     | Version: 1.0.23049  |     | Page 3 of 6  |
| ---------------- | --- | ------------------- | --- | ------------ |

WRM Escalation Messages
1 Overview of Escalation Messages for Shop Floor Data
Collection
Purpose
...
Integration
The events/ escalations already triggered in the WRM environment are posted to central escalation
...
the system.
Features
 Provision of various escalation messages in the resource environment such as, for example,
maintenance limits exceeded, maintenance reset, resource status changed or measure entered.
 Event configuration: Configuration of order-related events
 Forwarding of the detected event to the escalation framework.
WRM-ESK_81.docx Version: 1.0.23049 Page 4 of 6
...
| WRM-ESK_81.docx  |     | Version: 1.0.23049  |     |     | Page 5 of 6  |
| ---------------- | --- | ------------------- | --- | --- | ------------ |
...
| WRM-ESK_81.docx  |     | Version: 1.0.23049  |     |     | Page 6 of 6  |
| ---------------- | --- | ------------------- | --- | --- | ------------ |