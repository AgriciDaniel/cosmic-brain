...
3.1  Object "workplaces" .......................................................................................... 14

3.2  Object "order" .................................................................................................... 15

3.3  Object "operation" ............................................................................................. 16
...
To provide for more clarity the context is respectively defined within the formula management function.
...
  HYDRA Shop Floor Scheduling (HLS): to compute the remaining run time

  MES Link & Enabling (MLE): to calculate default values and/or to determine conditions

  Material & Production Logistics (MPL): Conversion of quantities into other quantity units

  Shop Floor Data Collection (BDE): to compute the processing time
...
Formula type, to be able to differentiate them logically
...
Comment Designation or description of the formula
...
The following operators and expressions may be used to formulate conditions:
...
The  AND  operator  "and"  delivers  the  value  1  (true)  if  both  conditions  are
TRUE. Otherwise, the value 0 (false) is returned.

The  OR  operator  "or"  delivers  the  value  1  (true)  if  one  of  the  conditions  is
TRUE. Otherwise, the value 0 (false) is returned.

The  relational  operator  "like"  delivers  the  value  1  (true)  if  the  first  operand
corresponds  to  the  pattern  of  the  second  operand.  Otherwise,  the  value  0
(false) is returned. The pattern may include the following placeholders: "*" --> 0
-n any characters
...
1 the bit  is set to 1 in the resulting  value. Otherwise, the bit  is set to 0 in the
resulting value
...
Please note for the definition of formulas in MES-Cockpit

Formula definitions used for MES-Cockpit provide the following features:

  Reference to other formulas

By stating @(<formula2>) a calculation can be based on an existing formula
...
Utilization in HYDRA-BDE (Shop Floor Data Collection)
...
The target cycle has been designed to monitor machines on the basis of cycles
within the scope of machine data collection (HYDRA-MDE).

- Remaining run time  The remaining run time of an operation is computed on the basis of the formula

that is defined for the operation (tab durations > RRT formula).

