...
Enhanced Inspection Planning / Inspection Steps
...
1  Enhanced Inspection Planning / Inspection Steps - Overview ..................... 4
...
1  Enhanced Inspection Planning / Inspection Steps - Overview

Purpose

This component expands the functions of the inspection planning to

  assign gages

  enter the formulas for the measured values from the results of other characteristics

  print inspection plans

Implementation Considerations

When  using  interface  equipment  to  automatically  capture  measured  values,  this  component  is  required

since it records the allocation of gages. Additionally, this function is required to calculate measured values

based on values previously collected.
...
  Entering  formulas  to  automatically  calculate  measured  results  with  reference  to  the  measured

values already collected for previous inspection characteristics

  Assigning  gages  or  gage  groups  with  the  capability  to  use  these  to  automatically  capture

measured values through the HYDRA measurement data interface

  Printing inspection plans, inspection results etc. as Word documents with the possibility to define

custom Word forms if Word forms defining and processing is licensed
