...
1  Gage Management Reports - Overview ...... Error! Bookmark not defined.
...
1  Gage Management Reports

Purpose

This component supplements the functions of the inspection requirements to

  display tolerance, action and warning limits,



visualize the collected measures, errors and measured values,

  access the list of documents.

Implementation Considerations

If the functions of inspection requirements require additional detailed information, use of this component

is recommended.

Integration

This component uses mainly the component "Calibration Inspection Planning".

Features

The following functions are available:

  Display of tolerance limits, action limits, sampling scheme etc.

  Display of characteristics related to the collected errors, measures and measured values

  Visualization of the processing status through various statuses (Released, Partial result, Finished

etc.)  and  the  assignment  or  determination  of  a  usage  decision  when  finishing  an  inspection

requirement (Release, Special release, Reject, Rework etc.)

  Visualization of collected inspection data (e.g. measured values) as a control chart and histogram

in addition to graphical display of historic calibration values

  Cross-sectoral tracing of measures including editing capabilities (Status, effectiveness, degree of

completion, actual date, comments on activities taken etc.)
