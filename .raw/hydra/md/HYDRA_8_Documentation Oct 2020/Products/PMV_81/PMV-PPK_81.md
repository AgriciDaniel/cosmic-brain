...
1  Calibration Inspection Plans - Overview ...... Error! Bookmark not defined.

2  Summary ...................................................................................................... 6

2.1  General notes on the document .......................................................................... 6

3  Groups ......................................................................................................... 7

3.1  Starting the function ............................................................................................ 7

3.2  Default Application Layout ................................................................................... 8

3.3  Toolbar ................................................................................................................ 8

3.4  Selection parameters ........................................................................................ 10

3.5

"Groups" Detail Application ............................................................................... 10

4  Characteristic Master Data ......................................................................... 12

4.1  Sampling scheme .............................................................................................. 24

4.2  Control charts for variable characteristics .......................................................... 25

4.3  Control charts for attributive characteristics ....................................................... 27

4.4  Computation of formulas ................................................................................... 27

5  Specification List ........................................................................................ 33

6  Configuration of Workplaces and Resources ............................................. 41

7  Resource Families ..................................................................................... 73

8  Failure Types ............................................................................................. 77

9  Failure Locations ........................................................................................ 80

10  Failure Causes ........................................................................................... 82

11  Causers ...................................................................................................... 84

12  Measures ................................................................................................... 86

13  Analysis Selection ...................................................................................... 88
...
14  Inspection Planning .................................................................................... 90

15  Inspection Requirements ......................................................................... 104

16  Resource History ...................................................................................... 140

17  Maintenance Calendar - Activities Calendar ............................................ 144
...
1  Calibration Inspection Plans
...
the  basis  for  the  collection  of  inspection  data.  Additionally,  for  each  gage  calibration  intervals  can  be

defined in the activity calendar.

Implementation Considerations

Since  creating  inspection  plans  is  the  basis  for  later  calibration,  this  component  for  documenting  a

calibration and defining calibration intervals, is required.

Integration

This component mainly serves the components:

  Master data / gage administration
...
  Maintenance functions to create and modify calibration inspection plans

  Versioning calibration inspection plans including managing historical data

  Calibration inspection plan release and activation using special rights

  Allocating  or  modifying  calibration  characteristics  of  various  characteristic  types  (variable,

attributive)

  Defining tolerance limits, units, inspection size etc.

  Allocating  any  document  (calibration  instructions,  pictures,  videos,  etc.  of  any  format)  to
...
  Generating  calibration  inspection  requirements  or  steps  based  on  calibration  inspection  plans

created earlier

  Creating calibration calendar entries to define calibration intervals
...
2.1  General notes on the document
...
4.2  Control charts for variable characteristics
...
4.3  Control charts for attributive characteristics
...
Production  facility  management    Production  facility  analysis    Resource
history
...
The resource history makes it possible for the user to gain an overview of what happened to a resource in

the past. In this way it is possible, for example, to trace activities that are relevant to quality ("log book").

The application maps the resource's "life cycle".

Usage

All of the actions with the object "Resource" are documented by  the system in this table. On one hand,

these  are  the  actions  resulting  from  resource  management  as  well  as  the  use  of  the  resources  in  the

orders  of  the  ADE,  which  can  include  both  production  and  maintenance  orders.  The  following  are
...
In this way whatever was done to and with the resources can be seen and documented at any time. The
...
This selection criterion refers to the resource type. Wildcards (placeholders *) can be used.

Resource

This selection criterion refers to the resource number. Wildcards (placeholders *) can be used.
...
This selection criterion refers to the resource family.

Status

This selection criterion refers to the current status of the resource.

Workplace type

With this selection criterion, a selection can be made between individual and group workplaces.

Cost center

This selection criterion refers to the cost center stored in the machine or  workplace master. All of

the  machines  or  workplaces  related  to  the  selected  cost  center  are  displayed.  Wildcards  can  be

used.

Designation

This selection criterion refers to the text in the resource master.

Order

This selection criterion refers to the order.

MES order number

This selection criterion refers to the order number.

Date from …to (shift/ time)

The period of the data to be evaluated can be limited using the date selection.

When selections are made using shift(s), the shift date is evaluated. If no shift is selected, all  shifts

are  considered.  Please  note  that  a  selection  according  to  shift  is  only  supported  for  order  and

machine data, not for resource data.

When  selections  are  made  according  to  time,  the  start  date  is  used  for  the  selection.  Both  times

refer respectively to the start or end of the date period specified above.

An  evaluation  of  workplaces  configured  as  "group  workplaces"  (resource  type  "MNR")  is  only

possible if the selection is made using "Time". When selections are made using "Shift", there is

no display because for group workplaces there is no shift reference.

Field descriptions

The fields are classified into these areas:

Event

The information regarding the event is listed here.

Resource

Information regarding the currently selected resources. Generally, the event refers to the resource

that is mentioned in the sub-section "resource master data".
...
master data" section as well as in the "workplace master data" section.

If  a  DNC  resource  is  either  uploaded  or  downloaded,  the  DNC  resource  is  entered  in  the

"resource master data" section and the machine from where data was uploaded or downloaded

is entered in the "workplace master data" section.

If a resource is changed (e.g. logon or logoff of a resources using the terminal, the resource is

entered  in  the  "resource  master  data"  section  and  the  relevant  machine  is  entered  in  the

"workplace master data" section.

Person

Information about the person or user performing the posting.

If  a  maintenance  activity  is  reset  using  a  terminal,  the  terminal  user  number  is  entered  in  the

"user" field in addition to the person. Provided that a maintenance activity is reset using MOC,

the user (MOC user) is entered.

The other columns are filled or are irrelevant depending on the event.

Resource status

Information regarding the set resource status of the status event.

Order

Information regarding the order event, e.g. the order that was current at the time of the event (event

time stamp).

Maintenance

Information regarding the maintenance event

Measure

Information regarding the measure event

Upload/ download

Information regarding the DNC event upload or download.
...
Please  note:  Two  events  are  documented  with  the  upload,  as  the  upload  is  processed  in  two

stages: dialog ID “N”: upload started. “F”: file saved in target folder. There is only one entry for the

download as only the file transmission is important.
...
The "resource overview" application can directly be opened here.

 Resource book

The resource book is a report providing the pieces of information pertaining to the resource history

in  a  formatted  way.  The  aim  of  this  function  is  to  make  data  printable  in  order  for  it  to  be  also

available as hard copy, e.g. for QA documentation purposes. Optionally, data may be grouped by

the relevant day within the daily report and by weeks within the weekly report.

The cover sheet shows master data information of the displayed and selected resources.

The view varies depending on the event.
...
17  Maintenance Calendar - Activities Calendar
