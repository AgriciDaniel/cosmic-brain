...
Enhanced Calibration Inspection Planning
...
1  Enhanced Calibration Inspection Planning - OverviewError! Bookmark not defined.
...
1  Enhanced Calibration Inspection Planning

Purpose

This component supplements the functions of the calibration inspection planning to

  enter the formulas for the measured values from the results of other characteristics and

  print calibration plans.

Implementation Considerations

If  a  formula  is  needed  to  automatically  calculate  measured  values  from  measured  values  already

collected for other characteristics, the use of this component is recommended.
...
  Printing  calibration  inspection  plans,  calibration  inspection  results  etc.  as Word  documents  with

the possibility to define custom Word forms if Word forms defining and processing is licensed
