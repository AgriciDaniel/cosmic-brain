...
Entry/Info Functions for Quality Data
...
Ist  noch  nicht  übersetzt  /  existent.  Dieser  Link  ist  als  Version  1.2
einzufügen.

Contents

1  Overview AIP Input/ Info Functions for Quality Data .................................... 6

2  Overview of Data Collection and Information Functions for Quality

Data on the AIP ............................................................................................ 7

2.1

Integration in the main view ................................................................................. 7

2.1.1  Due date status ....................................................................................... 8

2.1.2  Special features in case of shift change and queue mode ....................... 9

2.2

Inspector ID ....................................................................................................... 10

2.2.1  Constant user ........................................................................................ 10

2.2.2  Changing user ....................................................................................... 11

2.3  Recording of inspection results.......................................................................... 12

2.3.1  The inspection list .................................................................................. 13

2.3.2  The input panel ...................................................................................... 18

2.4  General input functions ..................................................................................... 19

2.4.1  Recording of failures .............................................................................. 19

2.4.2  Recording of measures ......................................................................... 20

2.4.3  Mandatory recording of failures and measures (as of CAQ 8.2 +

add-on) .................................................................................................. 22

2.4.4  Calculated characteristics ...................................................................... 22

2.4.5  Display and identification of the quality status (as of CAQ 8.2 +

add-on) .................................................................................................. 23

2.4.6  Automatic completion of inspection points (as of CAQ 8.2 + add-on) ..... 23

2.5  Recording with inspection points ....................................................................... 24
...
Inspection point characteristic ............................................................... 27

2.5.4  Attributive data collection ....................................................................... 29

2.5.5  Variable collection ................................................................................. 31

2.5.6

Inspection chart ..................................................................................... 32

2.5.7  Variable data collection with cavity ........................................................ 35

2.5.8  Visual assignment of failures (as of CAQ 8.2)........................................ 39

2.5.9

Inspections based on catalogs (as of CAQ 8.2) ..................................... 42
...
Inspections based on catalogs, random selection (as of CAQ 8.2) ........ 44

2.6  Data collection without inspection points ........................................................... 44

2.6.1  Attributive collection ............................................................................... 45

2.6.2  Variable collection ................................................................................. 45
...
2.7.1  Sampling (simplified) ............................................................................. 45

2.7.2  Advanced Sampling (as of CAQ 8.2) ..................................................... 49

2.8

Information on characteristics ............................................................................ 51

2.8.1  Description ............................................................................................ 51

2.8.2  Documents ............................................................................................ 52

2.8.3  Process overview - variable ................................................................... 56

2.8.4  Process overview - attributive ................................................................ 57

2.8.5  Control chart #1 ..................................................................................... 58

2.8.6  Control chart #2 ..................................................................................... 59

2.8.7  Histogram .............................................................................................. 60

2.8.8  Failure history ........................................................................................ 61

2.8.9  History of measures ............................................................................... 64

2.9  MDI drivers ........................................................................................................ 65

2.9.1  Backup of MDI drivers ........................................................................... 65

2.10  Document management (as of CAQ 8.2) ........................................................... 71

2.10.1  Configuration / inspection point ............................................................. 72

2.10.2  Configuration / attributive data collection ............................................... 73

2.10.3  Configuration / variable data collection .................................................. 73

2.11  Transferring measured values for all characteristics  (as of CAQ 8.2) ............... 74

2.11.1  Configuration in HYDRA ........................................................................ 75

2.11.2  Function description / operating instructions .......................................... 76

2.12  Saving measured values using the ENTER key (as of CAQ 8.2) ....................... 80

2.12.1  Configuration in HYDRA ........................................................................ 81

2.12.2  Function description / operating instructions .......................................... 81

2.13

Integration of CAQ-MPL/TRT (as of CAQ 8.2) ................................................... 82

2.14  Preceding list of inspection points (as of CAQ 8.2) ............................................ 83

2.14.1  Configuration ......................................................................................... 84

2.15  General notes .................................................................................................... 85

2.15.1  Field length in dynamic dialogs .............................................................. 85

2.15.2  Processing and display of automatic failures ......................................... 88
...
2.16  Asynchronous collection of measured values and failures (as of CAQ 8.1

and CAQ 8.2) .................................................................................................... 88

2.16.1  Configuration ......................................................................................... 89

2.16.2  Supported dialogs and actions .............................................................. 89

2.17  Calculated characteristic including calculation of eigenvalue (as of CAQ

8.2) .................................................................................................................... 90

3  Local configuration file caq_dc_t.ini ........................................................... 96

4  Local Configuration File caq72.ini ............................................................ 102
...
1  Overview AIP Input/ Info Functions for Quality Data

Entry/Info Functions for Quality Data

Purpose

This component allows you to enter test data.

Implementation considerations

Use this component when prompted to enter test data of any kind.
...
Inspection planning for calibrations, and
...
  Automatically log on/ off and interrupt inspection orders in direct connection with each posting to

the operations

  Automatically generate inspection points for each inspection due date event (for example when a

time or piece interval has been reached with a machine status change)

  Display  quality  relevant  details  during  the  inspection  (e.g.  gage,  control  chart,  specifications,

statistical values)

  Display inspection documents (sketch, drawing, photo, video) that are assigned to the inspection

plan

  Visualize upcoming inspections in the machine and order overview

  Show  the  available  inspections  with  status  information  by  breaking  them  down  in  the  form  of  a
...
2  Overview of Data Collection and Information Functions for
...
If a terminal is operated as a QM terminal, CAQ data is integrated in the so-called "tabular presentation".

Both in the list of machines as well as in the list of orders, two additional columns Inspection status and

Time are added; the information included in these two columns is the so-called due date status.
...
2.1.2  Special features in case of shift change and queue mode
...
2.1.2.1  Commands in queue mode
...
Communication with the HYDRA server is currently limited. Data will be updated when server communication is running

again and when no more dialogs are open.
...
2.1.2.2  Action when exiting queue mode
...
2.3.1.1  Buttons of the inspection list
...
If you click this button, a screen is displayed that includes information on the characteristic.
...
We could also integrate several buttons for updating. The user could then update various data, provided

that the required criteria are met (e.g. data relevant to the inspection point?)
...
2.3.1.4  Collection status

Particularly  in  view  of  measurement  recording,  we  generally  talk  of  a  collection  status  in  this  context.

However,  in  the  inspection  list  this  status  is  used  for  action  elements  not  associated  with  typical  data

collection.

Typical action elements for the collection status:

-  Attributive collection
...
For the following action elements the collection status can be considered as plain status information, as

the terminal user cannot influence these statuses.
...
If an assessment catalog is defined for a characteristic, these entries will also be restricted to the

selection made in the assessment catalog.
...
2.4.3  Mandatory recording of failures and measures (as of
...
2.4.4  Calculated characteristics
...
2.4.5  Display and identification of the quality status (as of CAQ
...
2.4.6  Automatic completion of inspection points (as of CAQ 8.2
...
2.5  Recording with inspection points
...
If  the  user  should  not  be  allowed  to  take  usage  decisions,  you  can  disable  the  access  to  the

selection list Usage decisions and to the fields Group and Code.
...
2.5.2.1  Configuration qee_insppoint.ini
...
2.5.4  Attributive data collection
...
The attributive recording also consists of the index tab  Defect/Failure data. This is the Classic recording

of failures on the AIP terminal. This dialog is integrated in many data collection functions.

This application records the defect data for each sample of relevant inspection point.
...
The inspection chart collection also includes the tab  Defect/failure data. This is the  Classic recording of

failures on the AIP terminal. This dialog is integrated in many data collection functions.
...
2.5.7  Variable data collection with cavity

You  can  only  use  variable  characteristics  to  collect  data  for  cavities.  You  cannot  use  attributive  or

inspection chart characteristics to collect data for cavities.

You  must  generate  inspection  points  to  collect  data  for  cavities  because  the  tool  is  assigned  to  the

inspection point and the tool specifies the number of cavities.
...
2.5.8  Visual assignment of failures (as of CAQ 8.2)
...
If the field "defective" is empty or includes the value 0, the application assigns the

value  1  when  the  first  defect  position  is  entered.  This  is  supposed  to  facilitate
...
- the inspection result (contents of the fields "checked", "defective" and "inspector") Characteristics are

not changed. The characteristic is still selected so that you can enter further defect positions.
...
An inspection result for the characteristic must be available in order to be able to

enter defect positions.
...
2.6  Data collection without inspection points
...
This message is only displayed if the terminal is online.
...
When  the  terminal  is  reconnected  to  the  HYDRA  server,  all  activities  that  have

been buffered are processed one after the other.
...
2.7.2  Advanced Sampling (as of CAQ 8.2)
...
Click the "Show info" button to request information on characteristics.

The sections in the following describe the information that is displayed on the terminal.
...
2.8.3  Process overview - variable
...
2.8.4  Process overview - attributive
...
Figure: Index tab "Process - attributive" in the dialog "information on characteristics"

(with Control chart #1)

Exiting information on characteristics

2.8.5  Control chart #1
...
This index tab  is hidden  if the characteristic  is not  a  variable characteristic,  or if

no input type with single-part inspection has been assigned to the characteristic.

Figure: Index tab "Histogram" in the information on characteristics
...
2.8.8.1  General failure history
...
2.10  Document management (as of CAQ 8.2)
...
2.10.1  Configuration / inspection point
...
can be managed in relation to inspection results recording.
...
2.10.2  Configuration / attributive data collection
...
2.10.3  Configuration / variable data collection
...
2.11  Transferring measured values for all characteristics  (as of
...
The user profits especially from the integrated data base as due dates of maintenance  take into account

operating times, performed cycles and other specific values.
...
2.11.2  Function description / operating instructions
...
Requesting meadured values from MDI driver
...
2.12  Saving  measured  values  using  the  ENTER  key  (as  of  CAQ
...
2.12.2  Function description / operating instructions
...
2.13  Integration of CAQ-MPL/TRT (as of CAQ 8.2)
...
It might be the case that  the "wrong  batch" is assigned and/or that the machine

cannot be identified distinctly for manually generated inspection points.

2.14  Preceding list of inspection points (as of CAQ 8.2)
...
The due date status is always set to "checked" in the basic screen of this mode.

Therefore, no further information on the due date, such as "due since" is shown.
...
after you exited the inspection.
...
exited the inspection point list. This also updates the inspection status. If you only

configure the parameter "ANR", the application only updates the order list. If this

option  does  not  exist,  the  order  and  machine  list  will  not  be  updated  when  you

exit the preceding inspection point list.
...
2.15.1  Field length in dynamic dialogs

The AIP terminal uses dynamic dialogs

  as a means of presenting information (e.g. inspection step)

or

  for the collection of data (e.g. inspection chart).

A mixed form (e.g. inspection point) is also possible.

The designed dialogs are user-friendly and meet the complex requirements of inspection data collection.
...
Effects of saving: abbreviated texts

If the text of fields (displayed or entered) must be abbreviated, you can still adjust

the size of the single fields in the dynamic dialog by way of configuration.
...
List of (text) fields that are saved by default in the system:
...
2.15.2  Processing and display of automatic failures
...
2.16  Asynchronous collection of measured values and failures
...
2.16.2  Supported dialogs and actions
...
2.17  Calculated characteristic including calculation of
...
o  Click the "Compute / calculator" button
...
3  Local configuration file caq_dc_t.ini
...
4  Local Configuration File caq72.ini
