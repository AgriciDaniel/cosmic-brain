...
This  component  enables  you  to  activate  cavity-related  data  collection  in  inspection  planning  with  cavity

reference  to  the  sample.  Consequently,  you  can  collect  and  evaluate  quality  data  in  relation  to  cavities
