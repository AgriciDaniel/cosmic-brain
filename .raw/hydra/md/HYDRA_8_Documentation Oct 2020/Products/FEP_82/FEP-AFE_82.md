...
1  Overview of Reports on Initial Sample Inspections ...................................... 4
...
1  Overview of Reports on Initial Sample Inspections

Purpose

This component extends the functions that are available for the inspection requirement.  The following is

added:

  Display of tolerance, action and warning limits

  Display of recorded measures, failures, measured values and statistical values

  Access to the list of documents.

Implementation notes

We recommend to use this component if you want to add further information and extend the functions of

the inspection requirements.

Integration

This component is linked to the component "Inspection planning for initial sample inspections".
...
  For the characteristic, display of recorded failures, measures, measured values, evaluations and

statistical values.

  Display  of  the  processing  status  (released,  partial  result,  completed,  etc.)  and  display  of  the

usage  decision  when  the  inspection  requirement  is  completed  (release,  exceptional  release,

rejection, rework, etc.)

  Display  of  the  documents  from  the  list  of  documents  that  is  assigned  to  the  characteristics,

inspection  plans,  inspection  plan  characteristics,  inspection  requirements  or  inspection  step

characteristics (drawings, images, videos of any format).
