...
HLS-RWP_81.docx Version: 1.0.23049 Page 2 of 12

|     |     |     | Setup Planning  |
| --- | --- | --- | --------------- |

Contents
1  Übersicht Rüstwechselplanung .................................................................... 4
2  Setup Change Matrix ................................................................................... 5

| HLS-RWP_81.docx  |     | Version: 1.0.23049  | Page 3 of 12  |
| ---------------- | --- | ------------------- | ------------- |

Setup Planning
1 Übersicht Rüstwechselplanung
Purpose
The function package provides the tools needed to specifically handle setup times resulting, for example,
from tool, material or color changes.
Implementation considerations
You use the function package if you have setup-intensive production and want to reduce setup times
during detailed scheduling.
Integration
By using setup change times, HYDRA shop floor scheduling can ascertain dynamic, i.e. occupancy-
dependent setup times. Setup change times can be defined for tool, material, color or article changes.
Features
...
 Differentiation by change of tool, color and product based on dynamic setup times that are
defined in the setup change matrix.
 Automatic elimination of static setup times that were transferred from ERP if the same tools,
colors and products were detected in operations scheduled to run one after the next
 Calculation of totals for setup and dismantling times (teardown)
HLS-RWP_81.docx Version: 1.0.23049 Page 4 of 12
...
| HLS-RWP_81.docx  |     | Version: 1.0.23049  | Page 5 of 12  |
| ---------------- | --- | ------------------- | ------------- |
...
HLS-RWP_81.docx Version: 1.0.23049 Page 6 of 12
...
| HLS-RWP_81.docx  |     |     |     | Version: 1.0.23049  |     | Page 7 of 12  |
| ---------------- | --- | --- | --- | ------------------- | --- | ------------- |
...
HLS-RWP_81.docx Version: 1.0.23049 Page 8 of 12
...
| HLS-RWP_81.docx  |     |     | Version: 1.0.23049  |     |     |     | Page 9 of 12  |
| ---------------- | --- | --- | ------------------- | --- | --- | --- | ------------- |
...
| HLS-RWP_81.docx  |     |     |     | Version: 1.0.23049  |     |     |     | Page 10 of 12  |     |
| ---------------- | --- | --- | --- | ------------------- | --- | --- | --- | -------------- | --- |
...
| HLS-RWP_81.docx  |     |     | Version: 1.0.23049  |     |     |     | Page 11 of 12  |     |     |
| ---------------- | --- | --- | ------------------- | --- | --- | --- | -------------- | --- | --- |
...
| HLS-RWP_81.docx  |     | Version: 1.0.23049  |     | Page 12 of 12  |     |     |
| ---------------- | --- | ------------------- | --- | -------------- | --- | --- |