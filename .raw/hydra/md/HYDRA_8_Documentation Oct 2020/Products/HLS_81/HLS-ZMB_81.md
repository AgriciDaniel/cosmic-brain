...
Objective-Driven Machine Assignment
...
1  Übersicht Zielgetriebene Maschinenbelegung ............................................. 4

2  Target-Oriented Planning ............................................................................. 5

3  Automatic Assignment ................................................................................. 7

3.1  Automatic assignment ......................................................................................... 7

3.1.1  Specification of the assignment order ...................................................... 9

3.1.2  Controlling capacity selection .................................................................. 9

3.1.3  Complete assignment of planning board ................................................ 11

3.2  Planning strategies/priority rules ........................................................................ 11

3.2.1  Rule-based machine scheduling ............................................................ 12

3.2.2  Variable machine assignment ................................................................ 12

3.2.3  Target-oriented machine assignment .................................................... 13
...
1
 ...
 Übersicht Zielgetriebene Maschinenbelegung

Purpose

Priority  rules  are  used  in  order  processing  for  detailed  scheduling  (and  sequencing)  once  an  order  has

been  released.  With  the  aid  of  priority  rules,  detailed  scheduling  determines  how  released  orders  are

assigned to workplaces. This becomes particularly important when several orders are lined up at a work

station and are awaiting processing, and thus are competing for resources.

Based  on  a  queuing  model,  a  random  number  of  resources  (generally  machines  /  workplaces)  are

combined,  from  which  a  queue  of  operations  ready  for  scheduling  is  formed.  Each  queue  is  given  a

priority rule to determine the highest priority operation (so-called contender) in the queue.

Implementation considerations

Using  this  priority  rule,  the  operations  to  be  scheduled  are  rated  and  indexed  using  an  adjustable

weighting, and the  queue is sorted (prioritized)  based on this index.  Unlike other sorting rules,  with this

one the actual objective is weighted and the assignment oriented based on the results.

You use the function package if you would like the queue sequence to be formed based on the weighted

objectives.

Integration

Planning  strategies  are  used  in  automatic  scheduling  /  assignment  in  order  to  determine  a  sequence

relating to the next highest-priority orders / operations.

Features

  Planning strategy used to control automatic machine occupancy based on weighted objectives:

  Evaluation of the operations to be scheduled using adjustable weighting and by generating an index,

based on which the queue is sorted.

  Configuration  option  used  to  define  the  objective-driven  rule  by  selecting  the  key  performance

indicators that are integrated in the rule.

  Selection of objective-driven rules when defining planning variants
...
3.1.1  Specification of the assignment order
...
3.1.2  Controlling capacity selection
...
3.1.3  Complete assignment of planning board
...
3.2  Planning strategies/priority rules
...
3.2.1  Rule-based machine scheduling
...
3.2.2  Variable machine assignment
