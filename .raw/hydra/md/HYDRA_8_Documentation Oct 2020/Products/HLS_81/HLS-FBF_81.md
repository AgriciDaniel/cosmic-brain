...
1  Overview – Detailed Scheduling and Assignment Functions ....................... 4
...
1
 ...
 Overview – Detailed Scheduling and Assignment Functions

Purpose

The  Detailed  Scheduling  and  Assignment  Functions  package  provides  functions  for  interactive/manual

planning of orders/operations on the graphic planning board.
...
The  result  of  the  planning  of  orders/operations  on  the  individual  machines  can  be  seen  in  the  order

sequencing  list  at  the  shop  floor  terminals:  The  operations  are  displayed  in  the  scheduled  sequence

according to the sequencing on the graphic planning board.
...
planning board or within the planning board), incl. assignment aids.

  Replanning to alternative machines

o  Shifting of operations to alternative machines, incl. assignment aids

  Closing of gaps in the machine assignment

o  Function for closing of gaps in the machine assignment

  Fixing of operations

o  Fixing of operations, visualization of the operation fixing
...
changes of the available capacity on the graphic planning board.

  Storage of notes

o  Operation-related  storage  of  notes  for  Production  which  can  be  displayed  at  the  Windows

terminal

  Planning of group workplaces

o  Definition of the shift-related personnel strength at group workplaces

o  Parallel assignment of operations at group workplaces

o  Calculation  of  the  capacity  utilization  at  group  workplaces  on  the  basis  of  the  defined

personnel strength and the dispatched operations
...
o  Calculation of the reserve capacity at group workplaces
