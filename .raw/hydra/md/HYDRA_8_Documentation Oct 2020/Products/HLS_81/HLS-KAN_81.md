...
1  Overview of Complex Order Networks ......................................................... 4
...
1
 ...
 Overview of Complex Order Networks

Purpose

This functions package provides functions used in association with relationships that span all orders. You

use this functions package in cases when you have linked orders, which, for example, may be the result

of a modular production.

Integration

The relationships between the orders are typically transferred via the interface from the ERP system.

Features

  The function accounts for the linked relationships between the production orders that play a role in

manufacturing a module.

  Transfers linked relationships through the HYDRA ERP/ PPS interface

(requires: SIS-ERP)

  Graphic presentation showing the linked relationships

  Accounts for linked relationships in the event of postponed dates, rescheduled dates or any other

planning activities.

  Provides the ability to manually define linked relationships
