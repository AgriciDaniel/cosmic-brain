...
you  wish  to  use  the  HYDRA  access  control  system  (ZKS)  to  assign  authorizations  for

entrances/accesses.

Integration

The configurations included in this function package represent the basis for further function packages of
...
o  Editing of badges including validity period

o  Assignment of a picture to the badge

o  Printing of badge lists where the fields to be printed may be chosen

o  Possibility to keep a badge history to retrace badge assignments

o  Automatic synchronization  of badges  if HR master data is changed (e.g.  name change,

person has left the company etc.)

o  Assignment  of  badges  to  responsibility  areas  to  control  which  users  may  view  and  edit

the badges and their data
...
o  Combination of accesses in access groups with the same settings and authorizations

  Time models

o  Time models to control access authorizations for weekdays and public holidays

  Public holiday calendar

o  Public holiday calendar that may vary for each location
...
o  Definition of the times when an entrance can be opened and when accesses and access

attempts are recorded

  Access profiles

o  Access authorizations are defined using access profiles that are assigned to the badges.

This  makes  it  possible  to  edit  changes  in  a  user-friendly  way  without  having  to  change

the badge authorizations in each individual case
