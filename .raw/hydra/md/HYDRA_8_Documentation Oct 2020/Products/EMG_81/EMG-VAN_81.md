...
 Energy Management - Energy Consumption Analysis
...
Efficient reports monitor the development of energy consumption and complement the basic evaluation of

the tabular consumption statistics.

The  following  functions  are  provided:  Listing  of  consumption  in  definable  periods;  management  of

settlement periods; definition of settlement periods; printing reports.

Select  a  hierarchy  and  display  a  table  of  the  company's  energy  counters.  Show  the  logical  energy

counters  assigned  to  machines  and  plant  equipment  and  display  the  consumption  values  and

comparative values. Display the counter hierarchy.
...
you want to list specific periods in summary.

you want to show or print data since the last settlement.

you want to reset meter readings after the current settlement and thus limit the analyzed period.

you  want  to  have  an  overview  of  the  current  status  of  energy  consumption  since  the  last
...
consumption of the real and the logical (calculated) meters over time.  Flexible filter settings and

compression functions are provided.

  Expand the monitoring of hierarchical energy data in order to evaluate historical data of definable

periods.

  Compress data in manifold ways by machines, counters, report groups and other logistic objects.
...
  List consumption in periods of your choice. List consumption in defined settlement periods. Select

by logistic objects, meters, machines or machine report groups.
...
  Complete a settlement period. Manage and store settlement periods including the status.

Energy Monitor

  Display the current energy counters and power meters in a dynamic tree-like structure.

  Display machines and other logistic objects in the structure of the counters and their connections.

  Create dynamic object hierarchies considering multiple selection criteria like counters, machines,

report groups and other logistic objects.

  Display  counters,  counters'  consumption,  limits  and  violations  of  limits  as  well  as  implausible
