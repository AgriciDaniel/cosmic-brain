...
Energy Management Manual Input
...
1  Summary of Energy Management, Manual Input ........................................ 4
...
1  Summary of Energy Management, Manual Input
...
This function package is used if you would like:



to record energy meters manually.

Integration

The function package EMG-MGM is required as basis for meter readings and manual input.

The package for mobile data collection is required if data is collected using HYDRA mobile terminals.
...
o  Definition of input plans for individual meter resources that are to be collected manually.

o  Definition of sequences for meter reading processes to be performed on the same day.

  Collection

o  Recording of meter values using the entry function in the meter reading plan.

  Collection using HYDRA-Mobile

o  Presentation  of  meter  readings  planned  for  this  day  and  the  ones  that  are  due  in  the

order as specified in routing.

o  Manual input of the measurement at the mobile terminal.
