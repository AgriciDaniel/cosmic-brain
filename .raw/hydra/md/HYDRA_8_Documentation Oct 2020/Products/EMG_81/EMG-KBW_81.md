...
1  Key Figure Overview (Relating to Energy) ................................................... 4
...
1  Key Figure Overview (Relating to Energy)

Summary

Possible fields of application

The "key figures" (relating to energy) function package allows for consolidated evaluations to be made of

the  data  (quantities,  durations,  consumption  values)  recorded  in  MDE  and  EMG  over  different  periods

and relating to defined key figures.

Implementation notes

The function package is used if:

  You would like to monitor and assess the performance of individual machines, machine groups or

departments on the basis key performance indicators relating to energy.

  You would like to assign consumption counters to individual machines for key figure calculation.

Integration

The times and quantities recorded in BDE or MDE as well as the consumption values entered in EMG are
...
o  Efficiency  report  relating  to  quantities  and  time  for  all  machines  over  individual  periods

and shifts

o  Recorded consumption values of the counters assigned to machines

o  Tabular  evaluation  of  key  performance  indicators,  specific  energy  consumption,  energy

consumption per machine hour and energy consumption per production hour.

  Assignment of counters to machines

o  Assignment  of  machines  to  counters  as  basis  for  the  consideration  of  key  performance
