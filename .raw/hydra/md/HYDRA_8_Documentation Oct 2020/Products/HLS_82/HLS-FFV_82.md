...
Detailed Planning with Production Variants
...
1  Overview – Detailed Scheduling with Production Variants .......................... 4

2  Processing Instructions in Conjunction with Production Variants ................ 5

3  Production Variants ...................................................................................... 6
...
1  Overview – Detailed Scheduling with Production Variants

Purpose

This  function  package  allows  the  management  of  relationships  between  article,  tool  and  machine  and

their consideration during assignment in the HYDRA shop floor scheduling (HLS).

You use the function package when

  You wish to ensure that due to the article to be produced, certain orders are manufactured only at

specific workplaces or with specific tools,

  Default  values  (e.g.  setup  time,  target  cycle)  change,  depending  on  the  use  of  a  tool  or

scheduling at a specific workplace

Integration

Production variants are taken into consideration in the graphic planning board both for manual scheduling

and automatic assignment.

Features

  Editing function for management of relationships between article, tool and machine.

  Selective control of the processing for specific order types or for specific machine/ workplace groups.

  Consideration  of  the  production  variants  (tool  selection  or  plausibility  check)  during  the  detailed

scheduling of operations in the HYDRA shop floor scheduling.

  Possibility of uploading production variants via an interface (customizing) and of manual processing in

MOC.

  Optional: Consideration of the production variants (tool selection or plausibility check) even during the

transfer of order sequencing data via the ERP/PPS interface
...
2  Processing Instructions in Conjunction with Production

Variants

Information on activation of the functions can be found in the following documents:

  Order types, document MOC_MDOrdertypes.pdf

  Groups, document MOC_Resourcegroups.pdf

Processing instructions in conjunction with production variants can be found in the following documents:

  Graphic planning board, document MOC_GraphicPlanning.pdf

  Automatic scheduling, document MBL_AutomaticPlanning.pdf
