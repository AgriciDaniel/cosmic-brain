...
Detailed Planning / Shop Floor Scheduling
...
Detailed Planning / Shop Floor Scheduling Version: 1.1.23049
...
You  can  define  individual  shift/assignment  times  within  the  Graphic

planning  and  the  Workplace  assignment  and  specify  for  a  workplace

within a specific period of time, whether this time is to be considered as

working time or idle time.

This enables short-term modifications with respect to the availability of

workplaces, without having to change the planned shift model.

This  application  manages  times  without  shift  or  shift  times  that  have

been  assigned  to  one  or  several  workplaces  within  the  functions

Graphic planning or Workplace assignment.

Integration

Normally,  individual  shift/assignment  times  are  directly  defined  by  the

corresponding  functionality  provided  in  the  Graphic  planning  or  the
...
The  product  group  Graphic  planning  or  Workplace  assignment  is  in
...
You  can  restrict  the  entries  to  a  specific  group  by  using  this
...
Optionally, you can use this input field to enter the beginning of a

period  as  of  which  you  want  to  display  the  entries  in  the
...
You  can  enable/disable  individual  shift/assignment  times.  The

Graphic planning does not include disabled entries.
...
Workplace  for  which  the  entry  (individual  shift/assignment  time)
...
the  entry  (individual

shift/assignment time) has been created.
...
If  it  is  not  working  time,  but  a  time  without  shift,  the  workplace

capacity  is  not  available  during  this  period.  Therefore,  you

cannot plan an operation.
...
You  can  store  a  short  comment  for  this  individual  shift  time
...
In  the  Graphic  planning,  you  can  display  the  comment  that  is

stored  for  an  individual  shift  in  the  tooltip  of  the  corresponding

individual shift (as of HLS 8.2). Enable (disable) the tooltip using
...
Use  the  available  buttons  to  create  or  edit  individual  shift/assignment
...
Only one entry can exist at a workplace for each period. If you make an

entry  and  the  system  detects  that  an  entry  already  exists  for  this

period, you can either delete the previous entry or cancel this entry.

If  multiple  individual  shift  times  exist,  this  dialog  is  opened  for  each

existing shift time, and the user can decide whether or not to delete the
...
Individual shift/assignment times ................................................................. 3

2  Overview of Detailed Planning / Shop Floor Scheduling ............................. 8

3  Planning Profiles ........................................................................................ 11
...
2  Overview of Detailed Planning / Shop Floor Scheduling

Purpose

Generally, production companies employ PPS or ERP  systems to manage internal resources. This type

of resource management is based on planning data and master data. Current information is available in

the  form  of  order  completion  confirmations  (i.e.  partial  or  final  completion  confirmations)  which  also

include quantities produced and the time required. Yet detailed information relevant to planning, such as

personnel  availability,  tool  availability,  machine  idle  times  or  machine  defects,  is  not  available.  Such

details  are  missing  when  it  comes  to  planning  based  on  daily  updated  data,  which  is  required  for

maximum utilization of capacities and profitability.

Data  collection  systems  that  are  close  to  production  (BDE)  provide  up-to-date  information  required  for

daily planning. Therefore, detailed planning, as a sub-function of production planning and control should

be done in the "shop floor level", i.e. the data collection system close to production.

HYDRA  Shop  Floor  Scheduling  meets  this  need  by  linking  PPS  and  ERP  systems  with  the  production

level.  The  basis  for  detailed  planning  in  the  HYDRA  Shop  Floor  Scheduling  is  provided  by  the  rough

planning carried out by the ERP/PPS system (MRP II run) and the current information collected with the

Shop Floor Data Collection module.

The diagram below shows the role of HYDRA Shop Floor Scheduling within the broader system context

of production planning and control and of data collection.

Within this context, Shop Floor Scheduling is responsible for the following tasks:

  Transfers orders (production, repair and maintenance orders) to the planning board

  Executes planning based on current process data (availabilities, malfunctions, etc.)
...
  When  the  operation  is  planned,  the  module  issues  a  start  and  end  time  (planned  start  and

planned end)

  Releases and hands over planning to order sequencing in the manufacturing process

  Uploads planning data to the ERP system

Current  planning  information  from  Shop  Floor  Data  Collection  is  displayed  in  the  HYDRA  Shop  Floor

Scheduling module and/or impacts the planning situation.

Workplaces  or  machines  are  highlighted  in  color  in  the  Shop  Floor  Scheduling  module  (HLS)  if  any

production  malfunctions  are  reported  automatically  or  by  staff.    In  addition,  graphical  representations  of

order  duration  are  shortened  or  lengthened  as  current  information  about  quantities  is  received.  Current

order  and  machine  data  is  retrieved  from  the  HYDRA  database  and  made  available  in  the  Shop  Floor

Scheduling module, thus depicting the current production situation.

Once  planning  has  been  confirmed  and  stored,  any  modifications  to  order  data  made  in  HYDRA  Shop

Floor Scheduling are passed on to order sequencing of the workplace.
...
you would like to perform sequencing for your workplaces and machines

Integration

The  ability  to  seamlessly  integrate  HYDRA  Shop  Floor  Scheduling  into  Order/Shop  Floor  Data  and

Machine  Data  Collection  allows  an  insight  into  current  production  results  such  as  order  progress,

produced yield and scrap quantities as well as machine downtimes. This guarantees that current planning

is always compared to the actual state.

Additionally,  HYDRA  Shop  Floor  Scheduling  is  linked  with  components  like  the  Tool  and  Resource

Management (WRM).

Features

This component provides special basic functions also accessed by the functions of other components.

  Calculation of the remaining run time
...
time/remaining  run  time  using  predefined  formulas.  Allows  for  the  performance  level

defined for the workplace.

  Display of current confirmations/uploads
...
o  Processes current MDE uploads (machine statuses).

  Display of predecessor/successor relations

o  Allows  for  predecessor/successor  relationships  of  linked  operations  within  a  multi-level

production order (order network).

  Display of shift calendars

o  Accounts  for  the  availability  of  machines  and  workplaces  based  on  assigned  shift
...
o  Provides an order / operation pool with reference to deadlines and durations

  Planning profiles

o  Allows for various planning profiles
