...
you want to get an insight into current planning

you want to quickly identify and use free capacities in production
...
o  Graphical  presentation  of  the  order  backlog  for  machines  /  workplaces  or  machine  /
