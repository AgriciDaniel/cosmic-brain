...
This  component  of  the  graphic  planning  board  in  HYDRA  Shop  Floor  Scheduling  allows  planning  to  be

carried out in a "virtual planning world" without changing the existing ("real") planning.

You use the function package if you:

  want to identify planning alternatives

  want to carry out long-term capacity evaluation

without changing current planning.

Integration

The  simulation  function  is  integrated  into  the  graphic  planning  board  of  the  HYDRA  Shop  Floor

Scheduling module. Practically all functions of the graphic planning board can also be used for simulation.

The  simulation  is  performed  based  on  the  order  backlog  available  in  the  system.  Due  to  the  special

simulation mode, saving of planning simulations has no impact on the real planning situation.

Features

  Simulation mode to develop the optimum planning situation without influencing current planning

  Simulative  changes  to  the  shift  calendar  increasing  (overtime,  special  shifts)  or  decreasing

(absences, maintenance) available capacities

  Visualizing effects of changed available capacities on machine assignment

  Buffering of automatically or manually generated variations of assignment

  Optional acceptance or rejection of the saved variations of machine assignment
