...
field staff are supposed to perform their clockings via an internet compatible device.
...
o  PZE clockings via the internet or intranet

o  Display of current account balances in the internet or intranet
