...
Dealing with Tools and Resources
...
1  Dealing with Resources - Overview ............................................................. 4
...
1  Dealing with Resources - Overview

Overview

Purpose

The  WRM  WRB  tool  and  resource  management  packet  provides  functions  to  assist  in  the  day-to-day

handling  and  managing  of  resources.  The  packet  allows  you  to  manage  resource  status,  implement

measures,  make  storage  postings  etc.  and  also  to  log  resources  on  through  production  orders.  These

postings  flow  into  the  resource  history.  Therefore,  the  packet  adds  dynamic  components  to  the  purely

statistical  master  data  update  function  and  opens  up  the  option  of  supporting  and  documenting  the

maintenance history of resources.

Integration

The packet requires the basic WRM MGM license.

Features

  Automatic posting of cycles, production figures (yield and scrap) as well as use times  (operating

hours) for logged on resources

  The tool creates the basic data used in the maintenance calendar and amortization calculations.

The data also flow into the resource history.

  Functions  for  defining  resource  availabilities  or  reservations  (release,  lock  and  lock  until  a

particular date)

  Active  collection  and  posting  of  status  changes  on  the  client.  Comment  entry.  Processing  of

postings from client or terminal

  Automatic release of resources after the blocking period has expired (reservation)

  Assignment of a home storage location for the resource as well as automatic assignment of the

current storage location (workplace) when logging on

  Manual  transfer  of  resources  to  defined  storage  locations  on  the  client.  Processing  of  postings

from client or terminal

  Capability  to  manually  enter  measures  incl.  comments  on  the  client  for  display  in  the  resource

history. The measures catalog is used as a model.  Processing of postings from client or terminal

  Editing and correction functions for postings entered
