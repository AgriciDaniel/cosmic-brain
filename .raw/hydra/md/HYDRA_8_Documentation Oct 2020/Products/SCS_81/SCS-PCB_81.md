...
Process Communication Controller BDE/MDE
...
1  Overview of Process Communication Controller - BDE/MDE ...................... 5

1  PCC Architecture ......................................................................................... 7

1.1  PCC Modules ...................................................................................................... 7

1.2  The channel principle .......................................................................................... 8

1.3  Architecture of the software components ............................................................. 9

1.3.1  Embedded PCC .................................................................................... 10

1.3.2  Stand-alone PCC with AIP2 without PDV .............................................. 11

1.3.3  Stand-alone PCC (with PDV) ................................................................. 13

2  Configuration of PCC and components ..................................................... 17

2.1  Configuration of the AIP2 terminal (ctaip.ini)...................................................... 17

2.1.1  Embedded PCC integration ................................................................... 17

2.1.2  Stand-alone PCC integration ................................................................. 17

2.2  Configuration of CTAIP terminal (ctaip.ini) ......................................................... 18

2.2.1  Embedded PCC integration ................................................................... 18

2.2.2  Stand-alone PCC integration ................................................................. 18

2.3  Configuration of CTWIN terminal (ctwin.ini) ....................................................... 19

2.3.1  Embedded PCC integration ................................................................... 19

2.3.2  Stand-alone PCC integration ................................................................. 19

2.4  PCC configuration (PCC.ini) .............................................................................. 20

2.5  PCCDLL configuration (pccdll.ini) ...................................................................... 23

2.5.1  Notes on the PDV timer processing in the pccdll ................................... 24

2.5.2  Trace files, logging of timer changes: .................................................... 25

2.5.3  Check of the PDV input channels by the driver ...................................... 26

2.5.4  HYDRA-DNC with HYDRA-PDV ............................................................ 26

2.5.5  Central counter conversion with a factor ................................................ 27

2.6  Module configuration (pccxxx.ini) ...................................................................... 28

3  Configuration of PCC as service ................................................................ 29

3.1  Preparations: HYDRA console .......................................................................... 29

3.2  Preparations under HYDRA 8 ........................................................................... 30

3.3

Installation on the shop floor server ................................................................... 31

3.4  Service does not start OPC server .................................................................... 37
...
4  Application blades ...................................................................................... 41

4.1  PDV blade configurations  pdv.dll ...................................................................... 41

4.2  Configurations of the MDE Blade  mdeb.dll ....................................................... 46

4.2.1  General configurations .......................................................................... 46

4.2.2

Interval to request the outputs to be set ................................................. 48

4.2.3  Mode to convert nominal output, set output and actual cycle ................. 48

4.2.4  DIGIN channel processing (extension for I:IXXX channel

configuration) ......................................................................................... 49

4.3  Configurations of the MDE Blade2 for the AIP2 (mdeb2.dll) .............................. 51

4.3.1  General configurations .......................................................................... 51

4.3.2  DIGIN channel processing (extension for I:IXXX channel

configuration) ......................................................................................... 55

5  PCC error handling .................................................................................... 59

5.1  Escalations of channel errors ............................................................................ 59

5.2  Diagnosis upload ............................................................................................... 60

6

Installation of the server service "FILE-DD-Server" for the PCC ............... 62
...
1  Overview of Process Communication Controller - BDE/MDE
...
to HYDRA via the interface between machine and server.

The  MPDV  controls,  CT-MSS  and  CT-UMPS,  are  also

supported.

Consequently, HYD-PCC directly provides the HYDRA modules with data and, as a result, indirectly even

the shop floor data collection module and the higher-level ERP system.
...
  Please note: There is a separate function package for the connection of PDV/DNC
...
  Recording process, HYD-PCC

o

"Scalable  recording  process  to  record  data  points  from machine  controls.  Acquisition  of

count values, status words, digital inputs and outputs and data transfer to machine data

collection.  Communication  interface  to  HYDRA  processing  services  and  HYDRA
...
Integration of various protocol modules to control different machine types

  Machine status

o  Recording  of  a  machine  status  and  other  parallel  resource  statuses  from machine  data

points through the PCC.

  Cycles, counter

o  Acquisition of count  values and/or cycle counters from machine data  points through the

PCC as basis for the computation of produced quantities (yield/scrap).



Inputs and outputs

o  Recording  of  digital  inputs  to  create  machine  status  or  for  machine  monitoring  from

machine data points through the PCC. Setting of digital outputs for BDE events.
