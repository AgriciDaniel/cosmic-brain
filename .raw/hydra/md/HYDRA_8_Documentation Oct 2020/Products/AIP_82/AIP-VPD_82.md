...
1  Overview: Visualizing Performance Data ..................................................... 4
...
3  PDV Functions - Process Visualization on the AIP .................................... 11

3.1  Displaying the process parameters ................................................................... 11

3.2  Changing target values ..................................................................................... 11

4  AIP2 -Local Configuration .......................................................................... 14

4.1

Local Configuration ctaip.ini .............................................................................. 14

4.2  PNG – Files / Bitmaps ....................................................................................... 18

4.2.1  File pict.zip ............................................................................................ 18

4.2.2  File pict_cust.zip .................................................................................... 18

4.3  Multilingualism (*.mld files) ................................................................................ 19

5  AIP2 - Central Configuration File hytnrcfg.ini ............................................. 20

5.1

Layout configuration .......................................................................................... 23
...
1  Overview: Visualizing Performance Data

Purpose

You can use the AIP functions provided in this product to display  performance data directly on the shop

floor terminal or data collection PC in production.

Implementation notes

You use this product if the following applies to you:

  You want to monitor the values collected via performance data collection online on the terminal.

  You want to visualize the values of your equipment via gauge instruments or trend lines.

  You want to display plant layouts with online measured values.

Integration

You can use the AIP to connect to the data published via MQTT broker using the visualization components.

The AIP can then display the collected values online.

Features

Use this product to display the collected process values in gauge or bar charts:

  Display the process trend over the last collected values

  Manually change the target values via specific dialogs

  Display individual layouts
...
Uniform selection lists are used in AIP 8.2 posting dialogs:
 ...
 If information is available for more than one page, the page numbers are displayed

below the table. The current page is highlighted in bold letters. If the user clicks/touches a page, the display

directly changes to this page.
...
This means: If Page 1 ... Page 9 were displayed for the page navigation, the system jumps to Page
...
entered, directly affects the table without having to update it. This process is realized through full-text search

for (defined) columns. The search is case-insensitive.

Virtual keyboard

Using the virtual keyboard, you can enter data manually via touch screen or a connected mouse. The virtual

keyboard is displayed automatically as soon as the focus is on an input field. The keyboard layout, which

is installed and activated in the Windows language settings, specifies the layout of the virtual keyboard.
...
If the date format used is other than the permitted formats, a note appears when the program is started and
...
Many AIP posting dialogs are divided into several views (sub-dialogs). These views (sub-dialogs) cover the

entire  screen  so  that  only  one  dialog  is  visible  at  a  time.  In  a  “workflow  concept”  the  user  is  navigated
...
The Cancel button is displayed in all sub-dialogs. Click this button to cancel/close the entire process at any

time.

To open the next view (Select status in the example), click the Next button or another tab (in our example:

Select status or Confirmation). Please note in this context, that no view can be skipped when they are

navigated upwards (view 1  view 2  view 3). This means: When you are in the first view (enter quantities)

and you click the third view (confirmation), the second view (select status) will be displayed first.

Vice versa, when navigating downwards (e.g. from the confirm view to the enter quantities view), each view

can directly be opened by clicking the required tab. In this case, views can actually be skipped. Using the

Back button, views are opened one after the other (upwards).
...
Filter field. Once the required values have been entered, the next view/sub-dialog can be opened by clicking

Next (in our example it is the last view).
...
3  PDV Functions - Process Visualization on the AIP

Purpose

Using the PDV basic functionality, the system transfers the inspection plans from the AIP to the relevant

interface via a driver DLL. Vice versa, the AIP transfers the incoming measured values to the MQTT Broker

for the online visualization and to the HYDRA server to save the data in the database.

Using the process visualization, you can monitor the current values of the process parameters on the AIP.

3.1  Displaying the process parameters

Press the button PDV on the AIP on workplace level to change to the display. The AIP dialog then shows

the current process parameters of the machine selected in the main view. You can also change to another

workplace in the PDV dialog. If no measuring channels are configured for the machine selected, an empty

PDV dialog is opened.

The  displayed  value  ranges  are  equal  to  the  tolerance  ranges  of  the  relevant  process  parameters

configured in the inspection plan.

Different modes are available to display the process parameters. Select the mode in the lower button bar,

e.g. pointer, bar or trend.

3.2  Changing target values

The target values are important for the display of the process data. Use the button Change target values to

change the values.

Posting process

Select the required workplace before changing the target values.

Calling the function Change default value

Press the button Change default value. When you start the function, you are guided through the dialog.

The workplace is preset.
...
Select the required process parameter from the existing list to change its target values.

Changing the target values

Enter the values that you want to change in this subdialog. The current value is also displayed. The following
...
Enter the staff badge number of the reporting person.

Confirmation Change target values

Confirm the dialog to update the target values in the system. The changed values also change the

PDV display on the AIP.
