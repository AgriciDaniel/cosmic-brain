...
Collection / Visualization Functions for energy-related data
...
The  AIP  features  contained  in  this  function  package  make  it  possible  to  display  energy-related  data

directly in production using shop floor terminals or data entry PCs.
