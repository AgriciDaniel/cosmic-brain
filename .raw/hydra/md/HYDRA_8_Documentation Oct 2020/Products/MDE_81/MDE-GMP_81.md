...
1
 ...
 Overview of Graphic Machinery

Purpose

The graphic machine park provides  a visual presentation  of the company's machine  park at a specified

level  (workshop,  foreman's  area,  …).  Not  only  does  this  function  visualize  master  data,  but  it  also

presents in real time actual data  recorded in MDE and BDE.
