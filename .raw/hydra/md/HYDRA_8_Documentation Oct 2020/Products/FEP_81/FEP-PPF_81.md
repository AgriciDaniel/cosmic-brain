...
1  Overview – Inspection Planning for In-process InspectionsError! Bookmark not defined.
...
This component permits the creation of inspection plans on the basis of previously created  master data

and  the  creation/management  of  inspection  requirements  which,  together  with  the  corresponding

inspection steps, form the basis for the inspection data collection.

Implementation Notes

As the creation of inspection plans forms the basis for a later inspection data collection, this component is

necessary where measured values and attributive inspection decisions are to be collected.

Integration

This component predominantly serves the components

  Collection/information functions for quality data (AIP)

  Extended inspection planning / inspection steps

  Family inspection planning

  Evaluations of in-process inspections and
...
  Editing  function  for  collection  and  editing  of  relevant  master  data  (articles,  companies,  errors,

measures, characteristics, etc.)

  Editing function for creation and editing of inspection plans

  Updating of inspection plans with revision history

  Release and activation of inspection plans using separate rights

  Assignment  or  changing  of  inspection  plan  characteristics  with  different  characteristic  types

(variable, attributive)

  Assignment  of  operations  and  inspection  stations  for  structuring  the  inspection  steps  to  be

created on the basis of the inspection plan

  Definition  of  the  tolerance  limits,  the  unit,  the  sampling  plan,  the  control  cards  to  be  used,

activation of the automatic error creation, etc.

  Assignment of random documents (drawings, images, videos in any format and internal notes) to
...
  Creation  of  inspection  requirements  /  inspection  steps  on  the  basis  of  previously  created
