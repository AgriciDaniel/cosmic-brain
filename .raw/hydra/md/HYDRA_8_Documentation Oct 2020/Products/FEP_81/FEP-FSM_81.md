...
1  Failure Mode Analysis / Measure Tracking .. Error! Bookmark not defined.
...
1  Failure Mode Analysis / Measure Tracking

Purpose

The component is employed when failure modes are to be identified on the basis of the recorded faults in

order to be able to initiate selective improvements in order to raise the product quality.

The  tracking  of  measures  allows  central  processing  of  measures  and  selective  filtering,  e.g.  by

incomplete measures.

Implementation Notes

Use of this component is to be recommended where as part of the inspection data collection, errors are

recorded or the automatic generation of errors is used and measures are initiated via the AIP.

Integration

The  component  "Inspection  planning  for  in-process  inspections"  with  the  corresponding  inspection

requirements  and  the  errors  and  measures  recorded  for  the  inspection  results  form  the  basis,  whereby

the inspection data must first be collected using the AIP collection client.

Features

The component offers the following functions:

  Graphic evaluation of the recorded error types, locations and causes with extensive filter criteria

and representation possibilities in the Form of a pivot analysis

  Tracking of measures across all orders with editing possibilities (status, effectiveness, degree of

fulfillment,  actual  completion  date,  comment  on  the  activities  performed,  filtering  by  responsible
