...
1  Overview – Standard Control Charts and HistogramsError! Bookmark not defined.
...
1  Standard Control Charts and Histograms

Purpose

This component extend the functions of the inspection requirements to include



the display of control charts and histograms.

Implementation Notes

The use of this component is to be recommended if the functions of the inspection requirements are to be

expanded to include the order-related display of the graphic value development over time.
...
Display of a control chart and histogram on each inspection order characteristic for clear visualization of

the collected inspection data (e.g. measured values)
