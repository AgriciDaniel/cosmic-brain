...
1  Overview of Initial Sample Inspection ReportsError! Bookmark not defined.
...
This component expands the inspection requirement functions by displaying
...
tolerance, action and warning limits,

the visualization of the collected measures, errors, measured values, statistical values and

the ability to access the list of documents.

Implementation considerations

We recommend use of this component if you would like to expand the inspection requirement  functions

by adding more detailed information.

Integration

This component primarily controls the "Inspection planning for initial sample inspection" component.
...
  Characteristic related display of the collected errors, measures, measured values and evaluations

as well as statistical values.

  Visualization of the processing status based on different states (released, partial results, finished,

etc.)  and  the  issuance/  determination  of  a  usage  decision  completion  (release,  special  release,

reject, rework, etc.)

  Display of documents (drawings, images, videos of any format) from the list of documents of the
