...
1  PCC-OPC Machine Connection - Overview ................................................ 5

2  Protocol Module PCC-OPC .......................................................................... 7

2.1  OPC communication ........................................................................................... 7

2.2  OPC server ......................................................................................................... 9

2.3  System requirements .......................................................................................... 9

2.4  Connection test using the OPC explorer .............................................................. 9

3  Configurations .............................................................................................. 9

3.1  Conditions / quantities ......................................................................................... 9

3.2  Overview of file assignments ............................................................................. 11

3.3  Configuration of the protocol module PCC-OPC ................................................ 11

3.3.1  Section [service] .................................................................................... 12

3.3.2  Section [instance x] ............................................................................... 12

3.4  DNC with OPC (DNC setting data download/upload) ........................................ 14

3.5  Sample configuration “opcmpdv.ini” file ............................................................. 18

3.6  Error codes and OPC client texts ...................................................................... 19

4  Enhanced configurations  (Beverage data collection) ................................ 21

4.1  Counter configuration ........................................................................................ 21

4.2  Time synchronization ........................................................................................ 21

4.3  Nominal capacity / configured capacity .............................................................. 24

4.4  Status recording ................................................................................................ 25

4.5

Input of a reason code for the status ................................................................. 26

4.6  Send date and time of the OPC client ............................................................... 26

4.7  Bit recording for IDs of the type H / F / B ........................................................... 27

4.7.1  Automatic adding of entries up to BIT32 ................................................ 27

4.7.2  Simplified configuration for BIT recording .............................................. 28

4.8  Alive signal ........................................................................................................ 29

4.8.1  Alive signal by time request ................................................................... 29

4.8.2  Alive signal by status channel ................................................................ 31

4.9  Configuration of output IDs in the OPC client  opcmpdv.ini ................................ 32

4.10  Alert status if connection between OPC server and UMPS is interrupted .......... 32

4.11  Extended logging with counter channels ........................................................... 34
...
1  PCC-OPC Machine Connection - Overview
...
To  connect  machines  with  the  HYDRA  system,  HYDRA  provides  an  OPC  client  (PCC-OPC)  that  is

integrated  in  the  software.  This  client  is  integrated  as  protocol  module  into  HYDRA-PCC  (Process

Communication Controller). Generally, all data fields (variables) of  a machine, which are made available

by an OPC server of the machine, can be read out using this client. This approach can be used for data

from the following HYDRA modules
...
MDE (counters/meters, cycles, statuses)
...
As the PCC-ADP application adapter has been enhanced, other data (e.g. HYDRA-MPL or HYDRA-ADE

data) as well as complex ways of communication may now also be processed.
...
specification in version 2.0 defines the data transport.

For  further  details  on  which  data  points  can  be  provided  by  a  specific  control,  please  refer  to  the

corresponding documentation about the control in question.

Integration

The  protocol  module  is  integrated  in  HYDRA  PCC.  Please  also  refer  to  the  manuals  dealing  with  the
...
  Configurable OPC client for the communication with OPC servers in external systems, machines,

equipment  and  controls  to  transfer  OPC  variables  (e.g.  machine  statuses,  process  data,  meter

readings  etc.)  and  NC  data  or  setting  parameters,  required  once  for  each  connected  machine,

aggregate or control.
...
2.4  Connection test using the OPC explorer
...
3.4  DNC with OPC (DNC setting data download/upload)
...
3.5  Sample configuration “opcmpdv.ini” file
...
3.6  Error codes and OPC client texts
...
4.3  Nominal capacity / configured capacity
...
4.5  Input of a reason code for the status
...
4.6  Send date and time of the OPC client
...
4.7  Bit recording for IDs of the type H / F / B
...
4.7.1 Automatic adding of entries up to BIT32
...
4.7.2 Simplified configuration for BIT recording
...
4.8.1 Alive signal by time request
...
monitored  in  the  machine  head  control  and  posted  as  communication  status,  see  section  4.4  "Status

recording" and section 4.8.2 "Alive signal by status channel".
...
4.8.2 Alive signal by status channel
...
4.9  Configuration of output IDs in the OPC client
...
4.10  Alert status if connection between OPC server and UMPS is
...
4.11  Extended logging with counter channels
