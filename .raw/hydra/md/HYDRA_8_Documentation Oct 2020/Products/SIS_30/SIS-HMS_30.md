...
if you want a notification in the MOC, you have linked the user in the User administration to a person
...
is logged in to the PZE system "time and attendance" (only in connection with PZE-BP).
