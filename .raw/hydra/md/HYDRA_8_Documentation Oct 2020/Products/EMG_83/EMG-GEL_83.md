...
Graphic Display of Energy Counters
...
1  Overview: Graphic Display of Energy Counters ........................................... 4
...
1
 ...
 Overview: Graphic Display of Energy Counters

Purpose

The graphic display of energy counters is based on the Graphic Machinery and visualizes a specific level

of a company's machinery (production hall, foreman's area,...). You can add energy counter resources to

this  graphic  machinery.  The  display  does  not  only  integrate  master  data,  but  also  current  actual  data

collected as part of the energy data collection.

Implementation notes

You use the function package for the following purposes:

  You want to display the available energy counters of your company and current actual data.

Integration

The application uses the current EMG data (e.g. counter status, current consumption) for the display. The

energy monitor provides this data in a table (EMG-GEM).

Features

  Graphic display

o  Graphic  display  of  a  company's  machinery  with  energy  counters:  production  hall,

department, supervisor's area, etc.

  Display of the current counter status

o  Display of the current resource status of the counter recources using different colors
...
o  Graphic  editor  to  create  layouts  of  halls  where  the  symbols  for  energy  counters,

machines,  machine  groups  and  production  lines  can  be  placed  according  to  your
