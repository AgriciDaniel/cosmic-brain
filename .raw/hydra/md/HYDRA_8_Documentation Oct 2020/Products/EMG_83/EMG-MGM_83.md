...
1  Overview: Energy Management ................................................................... 4
...
1  Overview: Energy Management

Purpose

This component is the basis for the operation of the HYDRA Energy Management. The German guideline

DIN EN ISO 50001 describes the requirements that an energy management for manufacturing companies

must fulfill. This standard has replaced the DIN EN 16001 since 2012. The MES system HYDRA provides

the basis and the tools to execute such a system as IT-based system. The HYDRA system focuses on

monitoring,  measuring  and  analyzing  energy  values.  The  system  also  contains  functions  to  define  and

document measures.

You use the function package for the following purposes:

  You want to manage energy counters in HYDRA.

  You  want  to  collect  energy  or  performance  values  for  these  counters.  Data  collection  is

automatically performed via HYDRA-PCC (process communication controller) or manually using

reading plans (EMG-AME).

  The package is the basis for all further packages of the energy management.

Integration

HYDRA-PCC is used for the automatic data collection. The PCC is not part of this package.

For the data evaluation, this basic package only includes a tabular list of raw data over a specified time,

which  is  also  used  to  correct  and  edit  data.  Use  additional  packages  for  monitoring  and  analysis

purposes.

If you use the WRM module at the same time, you can also collect status changes and maintenances of

the counter resources and evaluate them in a history.

Features

  Editing of master data and counter configuration

o  Management of actual energy measuring devices (counters) as resources. Generation of

logical, calculated counters so that several data collection positions can be combined to

groups. Counter values can be selected by shifts, days or months.

o  Functions  for  the  version  management  of  counters  and  reset  of  counters  when  counter

devices are exchanged.

o  Configuration and definition of counter channels for the collection of consumption values

and energy measurement.

o  Management and posting of resource statuses for the measuring devices.

o  Assignment of counters to workplaces or other logistic objects.
...
o  Management  of  logistic  objects  like  rooms,  halls,  buildings  and  of  machines  and

aggregate systems as resources.

o  Hierarchical object management: Sorting of buildings and systems, machines and energy

counters in a tree structure.

  Data collection, editing, data retention

o  Reception of counter values via Process Communication Controller.

o  Storage of the time-related counter values in the database. Posting and accumulation of

counter values for the resources.

o  Counter values and therefore consumption data can be corrected via manual collection of

correction records or editing of postings.
