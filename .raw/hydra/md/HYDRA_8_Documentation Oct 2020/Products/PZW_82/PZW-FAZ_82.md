...
settings are empty, the time is rounded using the normal rounding settings for flexitime or shift.
...
after end of skeleton time is rounded using the rounding settings Working time beforeafter end

of skeleton time specified in the Control of labor time calculation. If these rounding settings are

empty, the time is rounded using the normal rounding settings for flexitime or shift. Times that
