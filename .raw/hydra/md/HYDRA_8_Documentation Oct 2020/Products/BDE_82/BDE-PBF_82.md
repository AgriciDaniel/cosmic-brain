...
1  Overview: Staff-Related BDE Functions ...................................................... 4

2  Operator Position ......................................................................................... 6
...
1
 ...
 Overview: Staff-Related BDE Functions

Purpose

The function package provides functions for collection and posting of order-related labor utilization.
...
  You wish to employ comparison mechanisms between the Personnel Time Management (PZW)

module  and  the  Shop  Floor  Data  Collection  (BDE)  module  with  respect  to  the  entered  labor
...
You can evaluate the recorded or entered data in MOC using the applications of the BDE-PMA function

package. If corresponding interfaces are used, data can also be uploaded to a higher-level ERP system.
...
  Calculation of staff-related order times

o  Calculation  of  staff-related  order  times  as  the  basis  for  performance-related  wage

calculation. Entry of the labor utilization per operation.

  Posting rules

o  Different staff-related posting at individual workplaces and group workplaces.

  Shift model comparison

o  Comparison of recorded labor times with the BDE shift model stored at the workplace or

optionally with the person's individual BDE shift model.
...
o  Possibility  of  logging  off  staff  logged  on  to  operations  when  clocking  out  and  optional

logon when clocking in the next time.
...
The  employee  enters  the  operator  position  (=  function)  when  logging  on  to  a  workplace/machine.  They

select from a list of predefined operator positions/functions. Examples of operator positions/functions are:

machine operator, assistant, setter, ....

Requirements

The workplace has to be created.

If you want to be able to select or enter an operator function when logging on to the system, the

settings in the entry client needs to be customized.

Configuration changes

In order for the settings or changes made to be interpreted by the AIP, the AIP that is assigned

to the workplace/machine must be restarted.
