...
Advanced Shop Floor Data Posting Functions
...
1  Overview: Advanced Shop Floor Data Posting Functions............................ 4
...
1
 ...
 Overview: Advanced Shop Floor Data Posting Functions

Purpose

The  function  package  "advanced  shop  floor  data  posting  functions"  enhances  the  BDE  module  with

additional collection methods and options.

Implementation notes

You use the advanced shop floor data posting functions if
...
  You would like to have additional validation checks during posting of operations in order to increase
...
  are  used  as  a  basis  in  the  evaluations  of  the  function  package  "controlling  shop  floor  data  /  order

data"



can be uploaded to an upper-level ERP system via interfaces along with the entered quantities

The comments entered are available in the order information of the function package "monitoring shop floor
...
o  Extensive, configurable validation checks for OP postings (e.g. checking whether quantities
