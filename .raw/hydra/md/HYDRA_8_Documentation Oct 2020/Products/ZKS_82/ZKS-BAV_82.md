...
The management of visitor badges provides the function  of managing and printing visitor badges in the

system. The management of visitor badges also provides additional information fields on the badge. You

can configure the names of these fields.
...
you  want  to  use  the  HYDRA  access  control  system  (ZKS),  you  want  to  record  visitors  in  the

system and you want to authorize the visitors to open entrances using visitor badges.
