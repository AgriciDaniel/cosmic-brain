...
This function package includes functions to display reports on the access status, access logs and access
...
you want to have an overview of the status of accesses;

you want to list the logged accesses and access attempts and the last access of the badges;

you want to list the current access authorizations and the modifications to access authorizations.
...
o  You can display the current status of the individual accesses.

  Access log

o  You can list the logged accesses and access attempts.

  Last access

o  You can display a list of the last accesses of the badges.

  Access authorizations

o  You  can  display  the  access  authorizations  for  each  badge  or  access  group  over  a

specific period of time.

  History of authorizations

o  You can log and list the modified and deleted access authorizations including editor and
