...
o  Entry  of  cost  centers  at  PZE  terminal  via  selection  list,  bar  code  tableau  or  cost  center

badges (depending on terminal type)

  Cost centers

o  Functions for the administration and maintenance of available cost centers

  Printing of cost center badges

o  Print-out of cost center badges with bar codes to be read at the time recording terminal

  Maintenance of cost center logging
