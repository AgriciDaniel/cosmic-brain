...
1  PZW Escalation Messages - Overview ........ Error! Bookmark not defined.
...
1  PZW Escalation Messages

Possible fields of application

Application Service to generate events or to send messages within HYDRA Personnel Time Management
...
you would like to be notified when absence times are created, modified or deleted.

you would like to be notified in time when an employee joins or leaves the company or about an

employee's birthday or company anniversary.



you would like to be informed when an employee is absent (unplanned).

Integration

The  escalations  about  absence  times  and  employees  being  unplanned  absent  require  the  employees'

working times to be defined in Personnel Time Management (function package: labor time assessment).

Functions

  Escalation management

o  Configuration of relevant events

o  Forwarding  of  recognized  events  to  the  framework  of  HYDRA  Escalation  Management

(SIS-ESK)

  Escalations of Personnel Time Management

o  Employees arriving too late or being absent unplanned

o

Information on planned absences

o  Reminder  of  employees  joining  or  leaving  the  company,  birthdays  and  company
