...
1  Master Terminal with DS-100
This document is based on the manuals dealing with the HYDRA standard Windows terminals
(AIP or CTWIN). Consequently, this document only describes the special features if used as
master terminal as well as the operation of DS-100.
...
| TSW-MTS_base.docx  |     |     |     | Version: 1.0.1362  |     |     |     |     | Page 1 of 11  |
| ------------------ | --- | --- | --- | ------------------ | --- | --- | --- | --- | ------------- |
...
| 2.2  | MT3 - Overview  |     |     |     |
| ---- | --------------- | --- | --- | --- |
  An MT3 is exactly assigned to one machine. Quantities are recorded using the machine
interface (MSS).
  Please note: The "production" status must have a number > 20 for MT3 devices.

| TSW-MTS_base.docx  |     | Version: 1.0.1362  |     | Page 2 of 11  |
| ------------------ | --- | ------------------ | --- | ------------- |
...
| TSW-MTS_base.docx  |     | Version: 1.0.1362  |     | Page 4 of 11  |
| ------------------ | --- | ------------------ | --- | ------------- |
...
| TSW-MTS_base.docx  |     | Version: 1.0.1362  |     |     | Page 5 of 11  |
| ------------------ | --- | ------------------ | --- | --- | ------------- |
...
operation that is displayed on the DS-100 is incidental.
3.2.4 Configuration of the DS-100 device address
 Pull out and plug in again the 9-pole bus connector.
TSW-MTS_base.docx Version: 1.0.1362 Page 6 of 11
...
The below table compares figures in decimal and hexadecimal notation to make this clear:
...
TSW-MTS_base.docx Version: 1.0.1362 Page 7 of 11
...
address is to be entered as decimal number.
...
The relay is then set for all statuses assigned to “machine lock” as well as for the “not
assigned” status.
Please note: It is not possible to operate DS-100 and MT3 devices at one terminal.

| TSW-MTS_base.docx  |     | Version: 1.0.1362  |     | Page 8 of 11  |
| ------------------ | --- | ------------------ | --- | ------------- |
...
for the operation mode "master terminal". (by default: 5)
| Section [comports]  |     |     |     |     |
| ------------------- | --- | --- | --- | --- |
Com1=MASTER  The serial interfaces used for triggering the devices, have to
be entered as MASTER.

| TSW-MTS_base.docx  |     | Version: 1.0.1362  |     | Page 9 of 11  |
| ------------------ | --- | ------------------ | --- | ------------- |
...
Reset  Start date and time are entered here if a device has been restarted since starting of
the master terminal.     (not with MT3)
...
| TSW-MTS_base.docx  |     | Version: 1.0.1362  |     |     | Page 10 of 11  |
| ------------------ | --- | ------------------ | --- | --- | -------------- |
...
| TSW-MTS_base.docx  |     | Version: 1.0.1362  |     | Page 11 of 11  |
| ------------------ | --- | ------------------ | --- | -------------- |