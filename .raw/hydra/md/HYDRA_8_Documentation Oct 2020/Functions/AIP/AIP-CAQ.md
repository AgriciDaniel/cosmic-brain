Functions for Quality Data on the AIP

1Overview  of  Data  Collection  and
...
or completes the inspection data collection.
  ...
  Recording with inspection points
...
(MOC inspection point list: field 7)
  ...
  Saving  measured  values  using  the  ENTER  key  (as  of  CAQ
8.2)
