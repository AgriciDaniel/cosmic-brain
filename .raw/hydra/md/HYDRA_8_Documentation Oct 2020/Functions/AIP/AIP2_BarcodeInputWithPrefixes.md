...
16,200  Passed on to dialog with MNR=EXTRUDER-7 or MNR=200
17. 17.1 Machine status  Acronym <MST>
17.1001  Passed on to dialog with MST=1 or MST=1001
18. 18.1 Scrap reason  Acronym <EGG:AUS>
18.1001  Passed on to dialog with EGG:AUS =1 or EGG:AUS=1001
19. 19.1 Deviation reason  Acronym < EGG:GUT >
19.1001  Passed on to dialog with EGG:GUT =1 or EGG:GUT=1001
20. 20.1 Operator position  Acronym <BPOS>
20.MF  Passed on to dialog with BPOS =1 or BPOS = MF
21. Wage and premium indicators  Acronym <LPKZ>
-------- -------------------- ----HYDRA-WRM + HYDRA-DNC + HYDRA-PDV + HYDRA-MPL ---
40. 40,100 Destination  Acronym <ZLO>
40.MONTAGE  Passed on to dialog with ZLO=100 or ZLO= MONTAGE
41. 41.KARTON Transport unit  Acronym <TPE>
41.KISTE  Passed on to dialog with TPE = KARTON or TPE = KISTE
...
AIP2_BarcodeInputWithPrefixes.docx Page 1 of 6 19.06.20
...
52.VERTRIEB   Passed on to dialog with KST=EDV or KST=VERTRIEB
| 53.       | 53.1  Absence reason  Acronym <FGR>                       |     |     |     |     |
| --------- | ---------------------------------------------------------- | --- | --- | --- | --- |
|           | 53.1001   Passed on to dialog with FGR=1 or FGR=1001      |     |     |     |     |
|           |                                                            |     |     |     |     |
...
ANR=_ABCD12340100
*10._ABCD12340100*
| AIP2_BarcodeInputWithPrefixes.docx  |     |     | Page 2 of 6  |     | 19.06.20  |
| ----------------------------------- | --- | --- | ------------ | --- | --------- |
...
| ---- | --- | --- | --- | ----------- | --- |
*22.02*
| AIP2_BarcodeInputWithPrefixes.docx  |     |     | Page 3 of 6  |     | 19.06.20  |
| ----------------------------------- | --- | --- | ------------ | --- | --------- |
...
| ---- | --- | --- | --- | ------------ | --- |
*21.1221*
| AIP2_BarcodeInputWithPrefixes.docx  |     |     | Page 4 of 6  |     | 19.06.20  |
| ----------------------------------- | --- | --- | ------------ | --- | --------- |
...
51:PNR
52:KST
AIP2_BarcodeInputWithPrefixes.docx Page 5 of 6 19.06.20

|     |     | Barcode Input with Prefix  |
| --- | --- | -------------------------- |

AIP2_BarcodeInputWithPrefixes.docx  Version: 1.3.5255  Page 6 of 6