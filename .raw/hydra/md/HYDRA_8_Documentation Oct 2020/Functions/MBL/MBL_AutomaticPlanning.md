...
1.1.1  Specification of the assignment order
...
1.1.2  Controlling capacity selection
...
1.1.3  Complete assignment of planning board
...
1.2  Planning strategies/priority rules
...
1.2.1  Rule-based machine scheduling
...
1.2.2  Variable machine assignment
