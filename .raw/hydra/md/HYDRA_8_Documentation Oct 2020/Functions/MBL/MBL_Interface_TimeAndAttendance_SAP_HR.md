  Connection of the HYDRA Time and Attendance to SAP R/3 HR

1  Connection of the HYDRA Time and Attendance to SAP R/3
...
1.2  Processing of information fields
...
MBL_Interface_TimeAndAttendance_SAP_HR.docx
...
1.2.2  Simple transfer to the terminal
...
1.4.3  Authorization for responsibility areas
...
1.4.4  Message configuration for IMAIL and ZMAIL
...
1.4.7  Absence reason "business trip"
...
1.5  Useful functions of HYDRA  Time & Attendance
...
1.6  Overview of the HR-PDC interfaces
...
1.6.1.1  Access Control Group – Clocking Authorization
...
1.6.2  Download of time balances
...
1.6.2.1  Customization settings
...
1.6.3  Download of time event groups
...
1.6.4  Download of absence reasons
...
1.6.6  Download of cost centers
...
1.6.7  Download of internal orders
...
1.6.9  Download of external wage types
...
1.6.10  Upload of time events

1.6.10.1  Record types
...
1.6.10.3  Customization settings
...
1.6.11  Logs and Security Mechanisms
...
1.7  Connection of Several SAP Systems to HYDRA
